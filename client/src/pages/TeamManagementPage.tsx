...
import {
  AppBar, Toolbar, Typography, IconButton, Box, Card, CardContent, CardActions,
  Button, Stack, Chip, Avatar, Grid, Dialog, DialogTitle, DialogContent,
  DialogContentText, DialogActions, Alert, CircularProgress, Select, MenuItem,
      ...
      <Box>
        <AppBar position="static">
          <Toolbar variant="dense">
            ...
            <Typography variant="h6" sx={{ ml: 1 }}>Teams</Typography>
          </Toolbar>
        </AppBar>
    ...
    <Box>
      <AppBar position="static">
        <Toolbar variant="dense">
          ...
          <Typography variant="h6" sx={{ ml: 1, flexGrow: 1 }}>Teams</Typography>
          <Button
            color="inherit"
            startIcon={<AddIcon />}
