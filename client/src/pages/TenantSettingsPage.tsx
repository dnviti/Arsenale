...
import {
  AppBar, Toolbar, Typography, IconButton, Box, Card, CardContent, TextField,
  Button, Stack, Chip, Avatar, Table, TableBody, TableCell, TableContainer,
  TableHead, TableRow, Select, MenuItem, Dialog, DialogTitle, DialogContent,
  DialogContentText, DialogActions, Alert, CircularProgress,
} from '@mui/material';
import { ArrowBack, PersonAdd, Delete as DeleteIcon } from '@mui/icons-material';
      ...
      <Box>
        <AppBar position="static">
          <Toolbar variant="dense">
            ...
            <Typography variant="h6" sx={{ ml: 1 }}>Organization</Typography>
          </Toolbar>
        </AppBar>
    ...
    <Box>
      <AppBar position="static">
        <Toolbar variant="dense">
          ...
          <Typography variant="h6" sx={{ ml: 1 }}>Organization Settings</Typography>
        </Toolbar>
      </AppBar>

      <Box sx={{ maxWidth: 700, mx: 'auto', mt: 3, px: 2, pb: 4 }}>
        ...
        <Card>
          <CardContent>
            ...
            <Button variant="outlined" onClick={() => navigate('/settings/teams')}>
              Manage Teams
            </Button>
          </CardContent>
        </Card>
